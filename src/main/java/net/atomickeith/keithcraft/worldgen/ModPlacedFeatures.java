package net.atomickeith.keithcraft.worldgen;
...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> WISTERIA_PLACED_KEY = createKey("wisteria_placed");
    ...
    private static ResourceKey<PlacedFeature> createKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(KeithCraft.MOD_ID, name));
    }
